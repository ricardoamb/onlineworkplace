            ...
            <div class="left_col scroll-view">
                ...
                <div class="profile">
                    ...
                    <div class="profile_info">
                        ...
                        <h2><small>Controlador de Acesso</small></h2>
                    </div>
                </div>
                <!-- /menu profile quick info -->
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        <!-- COLISEU RESIDENCE -->
                        <h2 style="margin-left:15px;"><i class="fa fa-caret-right"></i>Coliseu Residence</h2>
            ...
            <div class="nav_menu">
                <nav>
                    <ul class="nav navbar-nav navbar-left">
                        <li><span class="message_upper">Message</span></li>
                    </ul>
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <img src="<?php echo base_url(); ?>assets/images/img.jpg" alt=""><?php echo $this->session->userdata('fullname'); ?> 
